...
![Native usage overview](media/4.6/usage-closure/01-overview.png)

![Actual model cost and token breakdown](media/4.6/usage-closure/03-breakdown.png)

![Scoped local energy and measurement coverage](media/4.6/usage-closure/05-energy.png)

![Local versus API with unavailable billing visible](media/4.6/usage-closure/06-local-vs-api.png)

![Native invocation detail](media/4.6/usage-closure/09-invocation-detail.png)

![Mobile usage overview](media/4.6/usage-closure/10-mobile.png)
