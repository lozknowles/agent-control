...
See [release verification](release-verification-4.9.0.md), [qualification report](../AGENT_CONTROL_4.9_SECURITY_QUALIFICATION.md), [integration decision](../SECURITY_AUDIT_INTEGRATION_DECISION.md), and the retained [completion evidence](evidence/security-audit-v4.9-completion/).
