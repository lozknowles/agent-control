...
- Source: [`src/control/token-aware-baton-routing.ts`](../src/control/token-aware-baton-routing.ts), [`src/control/codex-exec-provider.ts`](../src/control/codex-exec-provider.ts), [`src/control/openai-compatible-provider.ts`](../src/control/openai-compatible-provider.ts), [`src/control/application-service.ts`](../src/control/application-service.ts), [`src/control/web-server.ts`](../src/control/web-server.ts), [`assets/dashboard/dashboard-enhancements.js`](../assets/dashboard/dashboard-enhancements.js)
...
- Qualification evidence: [`docs/token-aware-baton-routing.md`](../docs/token-aware-baton-routing.md), [`docs/evidence/agent-control-3.7-development-qualification.md`](../docs/evidence/agent-control-3.7-development-qualification.md)
