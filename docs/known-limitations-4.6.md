...
Version: **4.6.0-rc.1**. This current classification supplements earlier qualification verdicts; historical failures and reports remain unchanged. Optional limitations do not waive core installation, usability, governance, security, data integrity or reproducibility checks.
