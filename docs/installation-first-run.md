...
This guide targets **Agent Control 4.8.1**. See the [release verification](release-verification-4.8.1.md), [release notes](release-notes-4.8.1.md), [nested execution guide](nested-execution-environments.md), and [known 4.7 foundation limitations](known-limitations-4.7.md).
...
[Upgrade safely](upgrade-4.8.md) · [All documentation](index.md) · [Release verification](release-verification-4.8.1.md)
