...
The public overview is an edit of genuine Windows browser recordings. Waiting
time is removed, private account details are redacted, and original recorded
speech remains paired with the corresponding browser actions. The full raw
qualification and complete natural conversation stay private.

## Installation and upgrade

Use the [4.1 installation/deployment runbook](installation-deployment-4.1.md).
...
See [architecture](../ARCHITECTURE.md), [dashboard operation](web-dashboard.md)
and [POE state/animation provenance](poe-dashboard-operator.md#state-and-animation-provenance).
