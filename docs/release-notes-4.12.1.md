...
- Authenticated, bounded workspace search across devices, nested environments, runtimes, workers, runs and invocations.
...
- Arbitrary file activation remains unavailable because Agent Control does not yet have an equivalent protected file-viewer path.
- Project and repository workspace semantics remain deferred until evidence-backed relationships are defined.
