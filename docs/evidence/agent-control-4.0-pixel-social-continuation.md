...
This addendum closes the sole physical dependency left open by the full 4.0 qualification. It does not replace or rewrite the original `PARTIAL` history in [the full qualification](agent-control-4.0-qualification.md).
