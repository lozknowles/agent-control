...
| AC-IA-012 | DOCUMENTATION | P1 | Product documentation presents the development machines, ports, systemd/Tailscale topology and physical device as normal installation architecture. | `README.md`, `TEST-TONIGHT.md`, `TODO.md`, `android/README.md`, `docs/architecture-v2-agnostic.md`, `docs/qualification.md`, `docs/remote-qualification.md`, `docs/ui-target.md`, `assets/article/agent-control-2.0-source-article.md`, `CHANGELOG.md` |
