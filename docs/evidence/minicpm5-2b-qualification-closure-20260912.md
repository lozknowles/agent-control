...
The exact configuration is `openbmb/MiniCPM5-2B-GGUF` revision `d00c954e5f9a0f2605468f24703ffa7e5cb0c492`, file `MiniCPM5-2B-Q4_K_M.gguf`, SHA-256 `ec2d5801640099e97d8d7e8003ad4d81f336e757811f03a26173dddf386602fd`, run with llama.cpp `0.4.0-dev` revision `311d4211bf1611ff7ca6b67035a4a07c79766efc`. The complete machine, runtime, performance, memory and evidence inventory is in the [external archive](../evidence-archive.md). The source tree retains only a [sanitized lightweight denial fixture](../../fixtures/model-qualification/minicpm5-2b-q4-k-m-failed.json) for the exact fail-closed routing regression.
