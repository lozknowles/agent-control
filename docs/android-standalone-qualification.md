...
1. [Local Android dashboard](media/4.6/android/android-local-dashboard.png).
2. [Environment Discovery](media/4.6/android/android-discovery.png).
3. [Phone in Estate](media/4.6/android/android-estate.png).
4. [Phone inspector](media/4.6/android/android-phone-inspector.png).
5. [Completed local job in Process Map](media/4.6/android/android-local-process.png).
6. [Crew on the phone](media/4.6/android/android-crew.png).
7. [Mallow explains model readiness](media/4.6/android/android-mallow-readiness.png).
8. [Controller unavailable — offline shell](media/4.6/android/physical-offline.png).
9. [Local run in Control Room](media/4.6/android/android-process-control-room.png).
