...
const config=validateConfig({schemaVersion:1,resources:[{id:'hpubuntu',name:'hpubuntu qualification controller',platform:'linux',capabilities:['qualification.local'],transport:{type:'local'},metadata:{capacity:1}}],providers:[],models:[],modelRouting:{roles:{}},services:[],lanes:[],deterministicSkills:{enabled:true,routingEnabled:true,minimumDistinctParcels:3,maximumValidationAgeDays:90}});
