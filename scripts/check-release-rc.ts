...
const verified=verifyReleaseEvidence({root,receiptFile,approvalFile:process.env.AGENT_CONTROL_RELEASE_APPROVAL_FILE,current:{version,sourceCommit,sourceDigest}});
