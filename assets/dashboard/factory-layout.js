...
export function entityColour(e){return /FAIL|QUARANTIN|KILL|STOP|CANCEL|CLEANUP/.test(e.state)?'#ed6c74':/SUCCEED|COMPLET|PASS|QUALIFIED/.test(e.state)?'#6bd6b2':/RUNNING|WORKING|ACTIVE|DISPATCH/.test(e.state)?'#73baf2':/VERIFY/.test(e.state)?'#bfadfa':/BLOCK|WAIT|PAUS|RETRY|RECOVER/.test(e.state)?'#e8bd70':'#829bb3';}
