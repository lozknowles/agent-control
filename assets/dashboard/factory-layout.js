...
export function entityColour(e){const states={EXPECTED:'#617a93',OBSERVED:'#70a3bd',IDENTIFIED:'#b8c3d4',VERIFIED:'#6bd6b2',CAPABILITY_VERIFIED:'#80e4ca',UNREACHABLE:'#ed6c74',STALE:'#987f70',CONFLICTED:'#fa8acc',BLOCKED:'#e8bd70',UNKNOWN:'#77828a',HISTORICALLY_OBSERVED:'#a999d2'};if(states[e.state])return states[e.state];return /FAIL|QUARANTIN|KILL|STOP|CANCEL|CLEANUP|CONFLICT|UNREACHABLE/.test(e.state)?'#ed6c74':/SUCCEED|COMPLET|PASS|QUALIFIED|VERIFIED/.test(e.state)?'#6bd6b2':/RUNNING|WORKING|ACTIVE|DISPATCH/.test(e.state)?'#73baf2':/VERIFY/.test(e.state)?'#bfadfa':/BLOCK|WAIT|PAUS|RETRY|RECOVER/.test(e.state)?'#e8bd70':'#829bb3';}
