...
function renderParcelLive(parcel, activeStage) {
  ...
  const requestedRoute = requested ? `${requested.provider || 'policy-selected provider'} / ${requested.modelRole || requested.model || 'policy-selected model role'} / ${requested.profile || 'policy-selected profile'}` : 'Normal Agent Control routing policy';
