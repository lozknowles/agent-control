...
function init(){
 ...
 document.addEventListener('agent-control:authentication-changed',()=>{authGeneration++;loading=false;labels={};if(!authorised()){lastEstate=null;document.dispatchEvent(new CustomEvent('precision:presentation'));}else load();});load();
