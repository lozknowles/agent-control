...
const metrics: WorkQueueMetrics = {total: 12, ready: 7, humanReview: 2, retrying: 1, oldestQueuedAgeMs: 7200000, byClass: {interactive: 1, priority: 2, background: 3, batch: 6}, byStatus: {queued: 7, blocked: 0, claimed: 1, running: 1, checkpointed: 0, completed: 1, failed: 0, 'human-review': 2}, batches: [{key: 'photos', items: 6}], resources: [{id: 'worker-foo', busy: .25, capacity: 1, utilisation: .25}], throughputPerHour: 20, estimatedDrainMs: 1800000};
