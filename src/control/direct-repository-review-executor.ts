  ...
  async execute(request: ReviewExecutionRequest): Promise<ReviewExecutionResponse> {
    ...
    while (chunkIndex < request.contextChunks.length) {
      ...
      try {
        ...
        this.recordAdaptiveFailure(parcel, request.route, message(error));
