...
export interface ParcelTokenTotals {
  parcelId: string;
  threads: string[];
  byModel: Array<{providerId: string; accountProfileId: string | null; accountLabel: string | null; accountPlan: string | null; modelId: string; nodeId: string | null; workloadNodeId: string | null; providerExecutionNodeId: string | null; credentialNodeId: string | null; inputTokens: number | null; outputTokens: number | null; totalTokens: number | null; cost: number | null; currency: string | null}>;
