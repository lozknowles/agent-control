...
export class AgentControlService {
  ...
  poeProjection() { return this.mustPoe().projection(); }
  ...
  poeConversation(id: string) { return this.mustPoe().conversation(id); }
  ...
  interruptPoe(id: string, actor: string) { const conversation=this.mustPoe().conversation(id);if(conversation.actorId!==actor)throw new Error('poe_conversation_actor_mismatch');return this.mustPoe().bargeIn(id,actor); }
