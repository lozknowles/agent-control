...
export class AgentControlService {
  ...
  agentTemplates(){const runtime=this.mustJobRuntime() as JobRuntime&{agentTemplates:AgentTemplateRegistry};return runtime.agentTemplates.list().map(record=>record.manifest);}
