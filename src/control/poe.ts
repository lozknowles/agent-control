...
export type PoeObjectKind = 'system' | 'schedule' | 'model' | 'league-row' | 'workflow' | 'job' | 'run' | 'parcel' | 'runtime-map' | 'crew-member' | 'lane' | 'routing-decision' | 'governor-decision' | 'capability-manifest' | 'baton' | 'execution-session' | 'verification' | 'benchmark' | 'human-evaluation';
