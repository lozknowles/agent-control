...
export class PoeRuntime {
  ...
  greeting(id:string,actor:string){
    ...
    const turn=this.addTurn(conversation,{purpose:'GREETING',actor:'poe',channel:'dashboard',modality:'text',text:this.options.operator?'Good day. I’m POE, your resident conversational operator. I can explain Agent Control, show recorded work, list available and scheduled jobs, guide approvals, and help begin governed work. How may I help you?':'Good day. I’m POE. How may I help you?',authority:'AGENT_CONTROL',contentTrust:'AGENT_CONTROL_EVIDENCE',references:[],evidence:[]});this.save();return {turn,conversation:clone(conversation)};
  }
