...
export interface WorkParcelStage extends WorkParcelPlanStage {
  ...
  baton?: {schema: 'agent-control.work-parcel-baton/v1'; artifactIds: string[]; outputTypes: string[]; transportContextSha256?: string; transportIntegrityState?: string};
